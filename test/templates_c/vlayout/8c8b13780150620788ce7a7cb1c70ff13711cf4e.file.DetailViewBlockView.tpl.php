<?php /* Smarty version Smarty-3.1.7, created on 2016-08-08 14:25:51
         compiled from "C:\wamp\www\vtigercolombia\galileoinstrument\includes\runtime/../../layouts/vlayout\modules\Assets\DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:588157a88728cd0917-93419360%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8c8b13780150620788ce7a7cb1c70ff13711cf4e' => 
    array (
      0 => 'C:\\wamp\\www\\vtigercolombia\\galileoinstrument\\includes\\runtime/../../layouts/vlayout\\modules\\Assets\\DetailViewBlockView.tpl',
      1 => 1470666344,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '588157a88728cd0917-93419360',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_57a8872a6b27c',
  'variables' => 
  array (
    'RECORD_STRUCTURE' => 0,
    'BLOCK_LABEL_KEY' => 0,
...
<?php if ($_valid && !is_callable('content_57a8872a6b27c')) {function content_57a8872a6b27c($_smarty_tpl) {?>
...
?><?php $_smarty_tpl->tpl_vars['BLOCK'] = new Smarty_variable($_smarty_tpl->tpl_vars['BLOCK_LIST']->value[$_smarty_tpl->tpl_vars['BLOCK_LABEL_KEY']->value], null, 0);?><?php if ($_smarty_tpl->tpl_vars['BLOCK']->value==null||count($_smarty_tpl->tpl_vars['FIELD_MODEL_LIST']->value)<=0){?><?php continue 1?><?php }?><?php if (($_smarty_tpl->tpl_vars['BLOCK_LABEL_KEY']->value=='Cantidad Accesorios')){?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("DetailInformacionEquipo.tpl",'Assets'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php }?><?php $_smarty_tpl->tpl_vars['IS_HIDDEN'] = new Smarty_variable($_smarty_tpl->tpl_vars['BLOCK']->value->isHidden(), null, 0);?><?php $_smarty_tpl->tpl_vars['WIDTHTYPE'] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('rowheight'), null, 0);?><input type=hidden name="timeFormatOptions" data-value='<?php echo $_smarty_tpl->tpl_vars['DAY_STARTS']->value;?>
