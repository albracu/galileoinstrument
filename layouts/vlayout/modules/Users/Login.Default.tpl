								...
								<div class="span8">
									<div class="login-area">
										<div class="login-box" id="loginDiv">
											<div class="">
												<h3 class="login-header">Login Galileo CRM</h3>
		</div>
				...
				<div class="controls">
												...
												<div class="control-group signin-button">
													<div class="controls" id="forgotPassword">
														<button type="submit" class="btn btn-primary sbutton">Iniciar</button>
											...
											<div class="login-subscript">
												<small> Powered by vtiger Colombia {$CURRENT_VERSION}</small>
											</div>
				</div>
